...
class AddMeaningModal(discord.ui.Modal, title='Add New Meaning'):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        embed.add_field(name="Meaning", value=self.meaning.value[:100] + "..." if len(self.meaning.value) > 100 else self.meaning.value, inline=False)
...
async def add_meaning_modal(ctx):
    ...
    await ctx.send("Click the button below to add a new meaning!", view=ModalView(modal))
...
class ModalView(discord.ui.View):
    ...
    @discord.ui.button(label='Add Meaning', style=discord.ButtonStyle.primary, emoji='➕')
    async def add_meaning_button(self, interaction: discord.Interaction, button: discord.ui.Button):
...
async def delete_meaning_command(ctx, *, word=None):
    ...
    embed.add_field(
        ...
        value=meanings[word_lower]["meaning"][:200] + "..." if len(meanings[word_lower]["meaning"]) > 200 else meanings[word_lower]["meaning"], 
        inline=False
    )
    embed.add_field(
